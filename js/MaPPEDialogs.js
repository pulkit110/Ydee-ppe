...
MaPPE.lostPasswordDlg = Ext.extend(Ext.FormPanel, {
	...
	initComponent : function() {
		...
		// Apply config and call base class
		Ext.apply(this, Ext.apply(this.initialConfig, config));
		MaPPE.lostPasswordDlg.superclass.initComponent.apply(this, arguments);
	}
});
	...
	initComponent : function() {
		...
		Ext.Ajax.request({
			...
			success : function(response) {
				...
				storeData.languages = new Array();
				var len = responseJSON.languages.length;
				for(var i = 0; i < len; i++) {
					storeData.languages[i] = new Object();
					storeData.languages[i].language = responseJSON.languages[i];
				}

				languageDataStore.loadData(storeData);
		...
		// Apply config and call base class
		Ext.apply(this, Ext.apply(this.initialConfig, config));
		MaPPE.selectLangDlg.superclass.initComponent.apply(this, arguments);
	}
});
...
MaPPE.personalInfoDlg = Ext.extend(Ext.FormPanel, {
	...
	initComponent : function() {
		...
		// Apply config and call base class
		Ext.apply(this, Ext.apply(this.initialConfig, config));
		MaPPE.personalInfoDlg.superclass.initComponent.apply(this, arguments);
	}
});
...
MaPPE.visibilityDlg = Ext.extend(Ext.FormPanel, {
	...
	initComponent : function() {
		...
		// Apply config and call base class
		Ext.apply(this, Ext.apply(this.initialConfig, config));
		MaPPE.visibilityDlg.superclass.initComponent.apply(this, arguments);
	}
});

MaPPE.userDlg = Ext.extend(Ext.Panel, {
	...
	initComponent : function() {
		...
		var config = {
			...
			items : [changePasswordDlg, lostPasswordDlg, personalInfoDlg, selectLangDlg, visibilityDlg]
		};

		// Apply config and call base class
		Ext.apply(this, Ext.apply(this.initialConfig, config));
		MaPPE.userDlg.superclass.initComponent.apply(this, arguments);
	}
});
